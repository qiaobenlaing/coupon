...
use Think\Model;
class ShopAppLogModel extends BaseModel {
    protected $tableName = 'ShopAppLog';
    ...
    public function getNewestShopAppVersion(){
        return $this->field(array('versionCode', 'updateUrl', 'isMustUpdate','updateContent'))->order('createTime desc')->find();
    }
}
