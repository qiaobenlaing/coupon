...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIs8KNUAwQFovA"; // AccessKeyId

        $accessKeySecret = "edbILH26kdUZPjFDjRDch10GMBlJ1F"; // AccessKeySecret
    ...
    public static function sendSms($mobileNbr) {
        ...
        $request->setSignName("惠付券");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_166868171");
