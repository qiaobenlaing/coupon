 ...
 *
 */
public class HomeTab implements java.io.Serializable  {
	 ...
	 * 没有选中的tab对应的图片
	 */
	private Bitmap mNotFocusedBitmap;
	...
	public Bitmap getFocusedBitmap() {
		return mFocusedBitmap;
	}

	public void setFocusedBitmap(Bitmap focusedBitmap) {
		mFocusedBitmap = focusedBitmap;
	}

	public Bitmap getNotFocusedBitmap() {
		return mNotFocusedBitmap;
	}

	public void setNotFocusedBitmap(Bitmap notFocusedBitmap) {
		mNotFocusedBitmap = notFocusedBitmap;
	}
	...
	public HomeTab(String id, String homeTabs) {
		super();
		this.id = id;
