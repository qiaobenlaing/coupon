...
public class ShopStaff implements java.io.Serializable {
	...
	public ShopStaff(String staffCode, long mobileNbr) {
		this.staffCode = staffCode;
		this.mobileNbr = mobileNbr;
	}

	public ShopStaff(String staffCode, String staffId, long mobileNbr,
			String password, String realName, String shopCode, Character sex,
			Integer province, Integer city, Integer district, String wechatId,
