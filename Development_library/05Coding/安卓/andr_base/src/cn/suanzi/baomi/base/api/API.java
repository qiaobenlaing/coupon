...
public class API {
	...
	private static String[][] NO_VCODE_METHODS = {
		...
		{"register","getNewestShopAppVersion","activate"},
...
//	}
	 ...
	 * @param target 请求目标，见Target接口中定义的常量。
	 * @param method 请求的方法名
	 * @param paramsArr 请求的参数列表，Map形式。注意：如果某个参数为数组，必须为对象数组。例如整型数组必须为Integer[] param2 = {new Integer(2), new Integer(3)}。否则将出现类转换异常。
	 * @return 返回一切正常时的结果，结果需要根据具体的方法进行强制转换。
...
//					}
	 ...
	 */
	protected static String getFirstParam(LinkedHashMap<String, Object> params) {
		String firstParam = "";
		if (params.size() > 0) {
...
//	}
	 ...
	 * @return vcode
	 */
	protected static String genSign(String method, String firstParam) {
