...
public class LoginTask extends SzAsyncTask<String, Integer, Integer> {
	 ...
	 *            启动本对象的Activity。
	 */
	public LoginTask(Activity acti, Class obj, String loginFlag) {
		super(acti);
		this.mSkipObj = obj;
	...
	protected Integer doInBackground(String... params) {
		try {
			...
			Log.d(TAG, "用户名：" + params[0] + "密码：" + params[1] + "loginType="
					+ SzApplication.getInstance().getCurrAppType() + "registrationId" + params[2]);
...
//		Log.d(TAG, "handldBuziRet>>>>" + mLoginFlag + "-- " + mSkipObj);
