 ...
 * @author yanfang.li
 */
public class GTask extends SzAsyncTask<String , String , Integer> {
	
	private static final String TAG = GTask.class.getSimpleName();
	/** 手机号不能为空*/
	 ...
	 * @param callback 回调方法
	 */
	public GTask(Activity acti , Callback callback) {
		super(acti) ;
