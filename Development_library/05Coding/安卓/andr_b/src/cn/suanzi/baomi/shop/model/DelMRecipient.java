 ...
 * @author yanfang.li
 */
public class DelMRecipient extends SzAsyncTask<String , String , Integer> {
	
	private static final String TAG = DelMRecipient.class.getSimpleName();
	/**创建一个JSONObject对象**/
	 ...
	 * @param acti
	 */
	public DelMRecipient(Activity acti) {
		super(acti) ;
	}
	 ...
	 * @param callback 回调方法
	 */
	public DelMRecipient(Activity acti , Callback callback) {
		super(acti) ;
	...
	protected Integer doInBackground(String... params) {
		...
		reqParams.put("recipientId" , params[0]) ;//商家编码
		reqParams.put("tokenCode" , userToken.getTokenCode()) ;//需要令牌认证
		try {
			mResult = (JSONObject) API.reqShop("delMRecipient" , reqParams) ;
