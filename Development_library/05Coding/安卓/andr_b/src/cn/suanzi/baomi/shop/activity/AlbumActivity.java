...
import cn.suanzi.baomi.shop.adapter.AlbumGridViewAdapter;
import cn.suanzi.baomi.shop.util.AlbumHelper;
import cn.suanzi.baomi.shop.util.Bimp;
import cn.suanzi.baomi.shop.util.ImageBucket;
...
public class AlbumActivity extends Activity {
	...
	private class AlbumSendListener implements OnClickListener {
		public void onClick(View v) {
			...
			ImageUploadActivity.clearImageUrl();
			startActivity(mIntent);
			finish();
