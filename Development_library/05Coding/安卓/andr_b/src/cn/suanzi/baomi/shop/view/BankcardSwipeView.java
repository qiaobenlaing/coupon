 ...
 * 列表项的侧滑删除
 */
public class BankcardSwipeView extends FrameLayout {
	//内容
	private LinearLayout mSwipeViewCotent;
	//删除按钮
	...
	public BankcardSwipeView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected void onFinishInflate() {
		...
		mSwipeViewCotent = (LinearLayout) getChildAt(0);
