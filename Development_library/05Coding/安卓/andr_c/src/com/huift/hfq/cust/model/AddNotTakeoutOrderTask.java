 ...
 * @author yanfang.li
 */
public class AddNotTakeoutOrderTask extends SzAsyncTask<String, Integer, Integer> {
	...
	public AddNotTakeoutOrderTask(Activity acti) {
		super(acti);
	}

	public AddNotTakeoutOrderTask(Activity acti, Callback callback) {
		super(acti);
	...
	protected Integer doInBackground(String... params) {
		...
		try {
			...
			mResult = (JSONObject) API.reqCust("addNotTakeoutOrderOtherInfo", reqparams);
