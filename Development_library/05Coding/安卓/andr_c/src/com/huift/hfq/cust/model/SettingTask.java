...
public class SettingTask extends SzAsyncTask<String, Integer, Integer> {
	...
	public SettingTask(Activity acti, Callback callback) {
		super(acti);
	...
	protected Integer doInBackground(String... params) {
		...
		try {
			// 调用API
			mResult = (JSONObject) API.reqCust("getUserSetting", reqparams);
