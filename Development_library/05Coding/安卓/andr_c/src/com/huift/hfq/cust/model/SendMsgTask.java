...
public class SendMsgTask extends SzAsyncTask<String, Integer, Integer> {
	...
	private final static String ERROR = "88003";
	...
	protected Integer doInBackground(String... params) {
		...
		try {
			int retCode = 0;
			/*Log.d(TAG, "sendMsg="+API.reqCust("sendMsg", reqparams).toString());*/
			//调用API
			mResult = (JSONObject) API.reqCust("sendMsg", reqparams);
