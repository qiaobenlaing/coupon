...
import com.huift.hfq.cust.adapter.CouponHistoryCardAdapter;
 ...
 * @author yanfang.li
 */
public class CouponUnusedFragment extends Fragment implements IXListViewListener{

	private final static String TAG = CouponUnusedFragment.class.getSimpleName();
	...
	public static CouponUnusedFragment newInstance() {
		...
		CouponUnusedFragment mFragment = new CouponUnusedFragment();
				...
				if (result == null) {
					...
					if (null == list || list.size() <= 0) {
						...
						if (mCardAdapter == null) {
							mCardAdapter = new CouponHistoryCardAdapter(getMyActivity(), list);
	...
	public void onResume() {
		...
		mPage = 1;
		getMyAvailableCoupon();
		MobclickAgent.onPageStart(CouponUnusedFragment.class.getSimpleName()); // 统计页面
	};
