...
import com.huift.hfq.base.pojo.CouponResult;
		...
		try {
			...
			if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
				...
				if (UPDATE_ACT.equals(message)) {// 修改活动
					// 自定义通知
					Notification notification = new Notification(com.huift.hfq.cust.R.drawable.ic_launcher, title, System.currentTimeMillis());
