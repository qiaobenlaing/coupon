...
public class TypeAdapter extends BaseAdapter {
	...
	public TypeAdapter(List<SubShopSortType> data, Context context) {
		super();
		this.data = data;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(subShopSortType.isCheck()){
			...
			Util.showImage((Activity)context, subShopSortType.getFocusedUrl(), holder.icon);
		}else{
			holder.describle.setTextColor(Color.BLACK);
			holder.selected.setVisibility(View.GONE);
			Util.showImage((Activity)context, subShopSortType.getNotFocusedUrl(), holder.icon);
		}
