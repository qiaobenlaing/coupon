...
import cn.suanzi.baomi.cust.activity.AlbumActivity;
import cn.suanzi.baomi.cust.activity.ShowAllPhoto;
...
//			holder.imageView.setImageBitmap( AlbumActivity.contentList.get(position).imageList.get(0).getBitmap());
	...
	private class ImageViewClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			ShowAllPhoto.mDataList = (ArrayList<ImageItem>) AlbumActivity.mContentList.get(position).imageList;
