...
public class AdviceTask extends SzAsyncTask<String, Integer, Integer> {
	private final static String TAG = AdviceTask.class.getSimpleName();
	/** 定义一个正确的返回结果码 **/
	...
	public AdviceTask(Activity acti, Callback callback) {
		super(acti);
	...
	protected Integer doInBackground(String... params) {
		...
		reqparams.put("targetCode", params[1]);
		reqparams.put("creatorCode", mUserToken.getUserCode());
