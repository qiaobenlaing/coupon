...
public class listUserShopBonusTask extends SzAsyncTask<String, Integer, Integer> {
	...
	public listUserShopBonusTask(Activity acti, Callback callback) {
		super(acti);
	...
	protected Integer doInBackground(String... params) {
		...
		try {
			// 调用API
			mResult = (JSONArray) API.reqCust("listUserShopBonus", reqparams);
