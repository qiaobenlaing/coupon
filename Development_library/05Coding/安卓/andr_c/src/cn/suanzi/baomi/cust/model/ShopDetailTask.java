...
public class ShopDetailTask extends SzAsyncTask<String, Integer, Integer> {
	...
	public ShopDetailTask(Activity acti, Callback callback) {
		super(acti);
	...
	protected Integer doInBackground(String... params) {
		...
		Log.d(TAG, "sshopCode===="+params[0]);
		
		try {
			// 调用API
			mResult = (JSONObject) API.reqCust("getShopInfo", reqparams);
			Log.d(TAG, "shopdetail>>>="+mResult.toString());
