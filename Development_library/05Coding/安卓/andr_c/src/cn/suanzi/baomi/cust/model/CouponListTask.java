...
public class CouponListTask extends SzAsyncTask<String, Integer, Integer> {
	private final static String TAG = CouponListTask.class.getSimpleName();
	/** 定义一个正确的返回结果码 **/
	...
	public CouponListTask(Activity acti, Callback callback) {
		super(acti);
	...
	protected Integer doInBackground(String... params) {
		...
		Log.i("===didian===", "longitude: " + params[3]);
		Log.i("===didian===", "latitude: " + params[4]);

		try {
			// 调用API
			mResult = (JSONArray) API.reqCust("getMyAvailableCoupon", reqparams);
