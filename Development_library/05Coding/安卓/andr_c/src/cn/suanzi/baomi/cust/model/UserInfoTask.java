...
public class UserInfoTask extends SzAsyncTask<String, Integer, Integer> {
	private final static String TAG = UserInfoTask.class.getSimpleName();
	/** 定义一个正确的返回结果码 **/
	...
	public UserInfoTask(Activity acti, Callback callback) {
		super(acti);
