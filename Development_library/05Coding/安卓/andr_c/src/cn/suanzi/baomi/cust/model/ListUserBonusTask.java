...
public class ListUserBonusTask extends SzAsyncTask<String, Integer, Integer> {
	...
	public ListUserBonusTask(Activity acti, Callback callback) {
		super(acti);
	...
	protected Integer doInBackground(String... params) {
		...
		try {
			// 调用API
			mResult = (JSONArray) API.reqCust("listUserBonus", reqparams);
