...
//            ->join('UserConsume ON UserConsume.orderCode = ConsumeOrder.orderCode', 'LEFT')
    ...
    public function listConsumeOrder($filterData, $page) {
        ...
        $consumeOrderList =  $this
            ->field(array('orderTime', 'orderNbr', 'orderAmount', 'shopName', 'Shop.logoUrl', 'nickName', 'User.avatarUrl', 'User.mobileNbr' => 'userMobileNbr', 'orderType', 'orderStatus', 'ConsumeOrder.orderCode', 'orderConfirm', 'ConsumeOrder.status'))
