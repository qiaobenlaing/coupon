...
//            return $this->getBusinessCode($code);
    ...
    public function listBatchCoupon($filterData, $type, $page) {
        ...
        $couponList =  $this
            ->field(array('batchCouponCode', 'Shop.shopCode', 'shopName', 'couponName', 'totalVolume', 'expireTime', 'startUsingTime', 'createTime', 'isAvailable', 'couponType', 'startTakingTime', 'endTakingTime', 'remaining', 'isUniversal', 'batchNbr', 'nbrPerPerson', 'insteadPrice', 'discountPercent', 'function', 'payPrice', 'remark', 'validityPeriod', 'isSend'))
