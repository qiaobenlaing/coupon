...
//    private $appid = "wxeea0a43338406e57";
    ...
    //7.添加优惠券到微信卡包
    public function  addWeixinCoupon($userCode,$shopCode,$userCouponCode){
        ...
        //4.获取上传微信的卡券图片
        $data_uploadimg = $this->upload($_SERVER["DOCUMENT_ROOT"].$batchCouponInfo['logoUrl'],$access_token);
        ...
        $data = $this->couponType($batchCouponInfo['couponType'],$userCouponCode,$img_url,$batchCouponInfo);
    ...
    //优惠券类型
    private function  couponType($type,$userCouponCode,$img_url,$batchCouponInfo){

        $batchCouponInfo['shopName'] = $this->cn_substr($batchCouponInfo['shopName'],11);


        $center_url_dai_dui = "\"https://".$_SERVER['HTTP_HOST']."/huiquan/coupondetails/".$userCouponCode."?from=weixin&openid_other=".$batchCouponInfo['openId']."\"";
        $center_url_di_zhe = "\"https://".$_SERVER['HTTP_HOST']."/huiquan/ksubmit/".$userCouponCode."?from=weixin&openid_other=".$batchCouponInfo['openId']."\"";
                    ...
                    $data = '{
                        ...
                        "cash": {
                          "base_info": {
                              ...
                              "description": "'.$batchCouponInfo['remark'].'",
                               "date_info": {
...
//    创建会员卡
    public function  createVipCard($CardShopInfo,$accesstoken){
       ...
       $shoname = $this->cn_substr($CardShopInfo['ShopName'],8);
        ...
        $data_uploadimg = $this->upload($_SERVER["DOCUMENT_ROOT"].$CardShopInfo['logoUrl'],$accesstoken);
                ...
                "card": {
                    ...
                    "member_card": {
                        ...
                        "base_info": {
                            ...
                            "custom_url": "https://hfq.huift.com.cn/huiquan?from=weixin&openId='.$CardShopInfo['openId'].'"
                        },
                        "supply_bonus": false,
...
// 上传临时文件到微信
    public function upload($file,$access_token){
    ...
    private function getSignPackageCoup($accesstoken) {
        ...
        $nonceStr = $this->createNonceStr();
        //$url = $this->get_url();
        $url = "https://hfq.huift.com.cn/huiquan/";//验证微信返回url地址
        // 这里参数的顺序要按照 key 值 ASCII 码升序排序
