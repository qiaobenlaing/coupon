...
class UserController extends AdminBaseController {
    ...
    public function listUser() {
        ...
        foreach ($userList as &$v) {
            ...
            $payValCode = $smsMdl->getCode(\Consts::MSG_VAL_ACTION_SET_PAY_PWD . $v['mobileNbr']);
            $v['payValCode'] = $payValCode ? $payValCode : '无';
        }
    ...
    public function editUser() {
        ...
        if(IS_GET) {
            ...
            $userInfo = $userMdl->getUserInfo(array('mobileNbr' => $mobileNbr), array('userCode', 'realName', 'mobileNbr', 'nickName', 'sex'));
