    ...
    public function listStaffShop() {
        ...
        switch($staffInfo['userLvl']) {
            case C('STAFF_LVL.MANAGER'):
                ...
                // 获得没有店长的商户
                $selectShopList = $shopStaffRelMdl->getNoMngShop();
                break;
            case C('STAFF_LVL.BIG_MANAGER'):
                $staffInfo['staffRole'] = '大店长';
                // 获得没有大店长的商户
                $selectShopList = $shopStaffRelMdl->getNoBigMngShop();
                break;
            case C('STAFF_LVL.EMPLOYEE'):
                ...
                $selectShopList = $shopMdl->getShopList(array('shopCode' => array('NOTIN', $shopCodeArr)), array('shopCode', 'shopName', 'province', 'city'));
                break;
            default :
