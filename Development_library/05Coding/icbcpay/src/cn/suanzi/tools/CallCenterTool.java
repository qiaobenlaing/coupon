...
public class CallCenterTool {

	public CallCenterTool() {
		bPublicInfomation = new byte[64];
		bDate = new byte[8];
		bSource = new byte[1];
		bSequence = new byte[1];
		bSerialsNo = new byte[2];
		bNumberOfData = new byte[3];
		bRegionCode = new byte[5];
		bTradeCode = new byte[4];
		bTeller = new byte[4];
		bGrantTeller = new byte[4];
		bReturnCode = new byte[2];
		bClientID = new byte[19];
		bStandby = new byte[6];
		bCrcFlag = new byte[1];
		bCrcCode = new byte[4];
		bProcess = new byte[2];
	...
	public byte bPublicInfomation[];
	public byte bDate[];
	public byte bSource[];
	public byte bSequence[];
	public byte bSerialsNo[];
	public byte bNumberOfData[];
	public byte bRegionCode[];
	public byte bTradeCode[];
	public byte bTeller[];
	public byte bGrantTeller[];
	public byte bReturnCode[];
	public byte bClientID[];
	public byte bStandby[];
	public byte bCrcFlag[];
	public byte bCrcCode[];
	public byte bProcess[];
	public static byte SEPERATOR = 124;
	public static byte MINOR_SEPERATOR = 33;
	public static byte END_FLAG = 94;
	public static byte TRANSFER = 92;
