//获取ID
var tmpObj = function (id) {return typeof id === "string" ? document.getElementById(id) : id};
//获取tagName
var oObj = function (tagName, oParent) {return (oParent || document).getElementsByTagName(tagName)};
//自动播放对象
...
AutoPlay.prototype = {
	initialize: function (id)
	{
		var oThis = this;
		this.oBox = tmpObj(id);
		this.oUl = oObj("ul", this.oBox)[0];
		this.aImg = oObj("img", this.oBox);
		this.timer = null;
		this.autoTimer = null;
		this.iNow = 0;
		this.creatBtn();
		this.aBtn = oObj("li", this.oCount);
		this.toggle();
