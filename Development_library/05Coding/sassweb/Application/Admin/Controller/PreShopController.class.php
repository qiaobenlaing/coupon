...
class PreShopController extends AdminBaseController {
    ...
    public function useTheShop() {
        if(IS_AJAX) {
            ...
            // 保存商户信息
            $editShopRet = $shopMdl->editShop2($preShopInfo);
    ...
    public function listPreShop() {
        ...
        $preShopList = $preShopMdl->listPreShop($data, array('PreShop.shopName', 'PreShop.bigManager', 'PreShop.bMaMobileNbr', 'PreShop.developerCode', 'PreShop.shopCode', 'PreShop.licenseNbr', 'PreShop.createDate', 'PreShop.type', 'PreShop.province', 'PreShop.city', 'PreShop.district', 'PreShop.street','PreShop.useTime', 'PreShop.status'), array(), 'createDate DESC', $this->pager);
...
//            }
            ...
            $shopTypeList = $shopTypeMdl->getAllShopTypeList2($where);
