...
//            $v['photoList'] = $photoList;
    ...
    public function listCoupon($couponType, $searchWord, $longitude, $latitude, $page, $city, $userCode = '',$zoneId) {
	 ...
	 $couponCoupon = $batchCouponMdl->countCoupon2($couponType, $searchWord, $longitude, $latitude, $city,$zoneId);
     ...
     */
    public function getMyAvailableCoupon($userCode, $shopCode, $status, $page, $longitude, $latitude,$city) {
        $userCouponMdl = new UserCouponModel();
		$UserCouponModel=D('UserCoupon');
        $userCouponList = $userCouponMdl->getMyAvailableCoupon($userCode, $shopCode, $status, $this->getPager($page), $longitude, $latitude,$city);
    ...
    public function getUserCouponInfo($userCouponCode) {
        ...
        $userCouponInfo['payPrice'] = $userCouponInfo['payPrice']/100; //分转元
