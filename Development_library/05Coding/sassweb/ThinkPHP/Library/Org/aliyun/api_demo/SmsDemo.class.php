...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIdtjdNRKKRk7y"; // AccessKeyId

        $accessKeySecret = "4Y2CfJEckLALHZJLuftf5AEeQM6VRp"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($mobileNbr) {

        // 初始化SendSmsRequest实例用于设置发送短信的参数
        $request = new SendSmsRequest();

        // 必填，设置短信接收号码
        $request->setPhoneNumbers("$mobileNbr");

        // 必填，设置签名名称，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
        $request->setSignName("李成阳");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_126356292");
		
		//引入memcache，把验证码存储在memcacche中
		$mem = new \Think\Cache\Driver\Memcache;
		
        // 可选，设置模板参数, 假如模板中存在变量需要替换则为必填项
		$c=rand(10000,99999);
		$vual=$mem->set('vcode1', $c, 300);
