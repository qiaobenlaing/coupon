...
#define FOREGROUND_STAR_IMAGE_NAME @"iconfont-starred"
#define BACKGROUND_STAR_IMAGE_NAME @"iconfont-stargray"
...
- (instancetype)initWithFrame:(CGRect)frame {
    return [self initWithFrame:frame numberOfStars:DEFALUT_STAR_NUMBER seleImage:FOREGROUND_STAR_IMAGE_NAME norImage:BACKGROUND_STAR_IMAGE_NAME] ;
}

- (instancetype)initWithCoder:(NSCoder *)aDecoder {
    if (self = [super initWithCoder:aDecoder]) {
        _numberOfStars = DEFALUT_STAR_NUMBER;
        [self buildDataAndUIbgImage:BACKGROUND_STAR_IMAGE_NAME seleImage:FOREGROUND_STAR_IMAGE_NAME];
    }
    return self;
}

- (instancetype)initWithFrame:(CGRect)frame numberOfStars:(NSInteger)numberOfStars  seleImage:(NSString *)seleImagestr norImage:(NSString *)norImageStr {
    if (self = [super initWithFrame:frame]) {
        _numberOfStars = numberOfStars;
        [self buildDataAndUIbgImage:norImageStr seleImage:seleImagestr];
    }
    return self;
}
...
- (void)buildDataAndUIbgImage:(NSString *)norImage seleImage:(NSString *)seleImage{
    _scorePercent = 1;//默认为1
    _hasAnimation = NO;//默认为NO
    _allowIncompleteStar = NO;//默认为NO

    self.foregroundStarView = [self createStarViewWithImage:seleImage];
    self.backgroundStarView = [self createStarViewWithImage:norImage];
