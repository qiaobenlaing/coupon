...
//
    ...
    if (self.isModify) {
        ...
        size = [title sizeWithFont:[UIFont systemFontOfSize:ZCScreenWidth * 0.053125] andMaxSize:CGSizeMake(MAXFLOAT, MAXFLOAT)];
        titleY = ZCScreenWidth * 0.03125+titleY*2+titleH;
        titleW = size.width;
        titleH = size.height;
        ...
        attr_price[NSFontAttributeName] = [UIFont systemFontOfSize:ZCScreenWidth * 0.053125];
        ...
        CGFloat y = ZCScreenWidth * 0.40625 * 0.5+titleY+10;
        CGFloat w = ZCScreenWidth * 0.846875;
        CGFloat h = ZCScreenWidth * 0.121875;
        ...
        CGFloat pointW = ZCScreenWidth * 0.05;
        CGFloat pointH = pointW;
        CGFloat pointY = ZCScreenWidth * 0.24+titleY+10;
        CGFloat pointX;
