...
+ (NSString*) value {
    ...
    NSString *uuid = [SSKeychain passwordForService:@"com.baomi.cust" account:@"baomicust"];
    //NSLog(@"uuid:%@",uuid);
    //2eac1f3b2e6bd9e1075dcbef2e5441daa893352c
    //2eac1f3b2e6bd9e1075dcbef2e5441daa893352c
    if (uuid == nil) { // if this is the first time app lunching , create key for device
        uuid  = [OpenUDID valueWithError:nil];
        if(uuid!=nil){
            // save newly created key to Keychain
            uuid=[MD5 MD5Value:uuid];
        [SSKeychain setPassword:uuid forService:@"com.baomi.cust" account:@"baomicust"];
