...
- (UIImageView *)iwantIcon{
    if (!_iwantIcon) {
        UIImageView *iwantIcon = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"progress_loading_1.png"]];
        iwantIcon.bounds = self.arrowImage.bounds;
        [ self addSubview:_iwantIcon = iwantIcon];
    }return _iwantIcon;
}
...
- (void)layoutSubviews
{
    ...
    // 2.icon
    self.iwantIcon.frame = CGRectMake(0, 0, 25,30);
    self.iwantIcon.center = self.arrowImage.center;
}
...
//========================  修改部分    ===========================//
            // 开始转圈圈
            self.iwantIcon.hidden = NO;
            UIImage *image = [UIImage animatedImageNamed:@"progress_loading_" duration:1];
            self.iwantIcon.image = image;
//===============================================================//
            // 隐藏箭头
