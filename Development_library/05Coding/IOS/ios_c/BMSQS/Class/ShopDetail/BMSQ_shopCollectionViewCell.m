...
-(id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        self.backView = [[UIView alloc]initWithFrame:CGRectMake(15, 10, APP_VIEW_WIDTH/2-30, APP_VIEW_WIDTH/2-10)];
...
//    [self.ImageView setImageWithURL:[NSURL URLWithString:str] placeholderImage:[UIImage imageNamed:@"iv__noShopLog"]];
