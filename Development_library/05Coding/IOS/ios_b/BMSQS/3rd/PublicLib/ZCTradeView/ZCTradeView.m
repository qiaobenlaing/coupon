...
{
    [self showInView:[UIApplication sharedApplication].keyWindow price:price card:cardMessage];
}

- (void)showInView:(UIView *)view price:(NSString *)price card:(NSString *)cardMessage
{
    // 浮现
    ...
    self.inputView.priceStr = price;
    self.inputView.cardMessagte = cardMessage;
...
- (void)show:(NSString *)price card:(NSString *)cardMessage mobileNum:(NSString *)mobileNum
{
    [self showInView:[UIApplication sharedApplication].keyWindow price:price card:cardMessage mobileNum:mobileNum];
}
- (void)showInView:(UIView *)view price:(NSString *)price card:(NSString *)cardMessage mobileNum:(NSString *)mobileNum
{
    // 浮现
    [view addSubview:self];
    ...
    self.inputView.width = ZCScreenWidth * 0.94375;
    self.inputView.x = (ZCScreenWidth - self.inputView.width) * 0.5;
    self.inputView.mobileNum = mobileNum;
    self.inputView.priceStr = price;
    self.inputView.cardMessagte = cardMessage;
...
- (void)showInCodeView:(UIView *)view price:(NSString *)price card:(NSString *)cardMessage mobileNum:(NSString *)mobileNum {
