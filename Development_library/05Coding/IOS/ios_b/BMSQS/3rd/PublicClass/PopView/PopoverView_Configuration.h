...
#define kGradientBottomColor  [UIColor colorWithRed:0.329 green:0.341 blue:0.353 alpha:kBoxAlpha]//[UIColor colorWithRed:0.98f green:0.98f blue:0.98f alpha:kBoxAlpha]


//top color white value in gradient bg
#define kGradientTopColor [UIColor colorWithRed:0.329 green:0.341 blue:0.353 alpha:kBoxAlpha]//[UIColor colorWithRed:1.f green:1.f blue:1.f alpha:kBoxAlpha]
...
//normal text color
#define kTextColor [UIColor colorWithRed:1.f green:1.f blue:1.f alpha:kBoxAlpha]//[UIColor colorWithRed:0.329 green:0.341 blue:0.353 alpha:1]
// highlighted text color
#define kTextHighlightColor [UIColor colorWithRed:1.f green:1.f blue:1.f alpha:kBoxAlpha]//[UIColor colorWithRed:0.098 green:0.102 blue:0.106 alpha:1.000]
