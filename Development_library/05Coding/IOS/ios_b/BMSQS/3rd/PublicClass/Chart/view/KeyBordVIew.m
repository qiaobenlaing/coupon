...
-(void)initialData
{
    ...
    [self setBackgroundColor:[UIColor colorWithRed:234/255.f green:234/255.f blue:234/255.f alpha:1]];
    ...
    self.textField=[[UITextField alloc]initWithFrame:CGRectMake(0, 0, self.frame.size.width*0.75, 30)];
    self.textField.returnKeyType=UIReturnKeySend;
    self.textField.center=CGPointMake(self.frame.size.width*0.4, self.frame.size.height*0.5);
    ...
    self.textField.layer.borderColor = [UIColor colorWithRed:207/255.f green:207/255.f blue:207/255.f alpha:1].CGColor;
    ...
    [self.imageBtn setCenter:CGPointMake(self.frame.size.width*0.9, self.frame.size.height*0.5)];
    //[self addSubview:self.imageBtn];
    
    NSString *str = str = NSLocalizedString(@"发送", @"发送");
    self.addBtn=[self buttonWith:nil hightLight:nil action:@selector(addBtnPress:)];
    [self.addBtn setTitle:str forState:UIControlStateNormal];
    [self.addBtn setTitle:str forState:UIControlStateHighlighted];

    [self.addBtn setFrame:CGRectMake(0, 0, 60, 30)];
    [self.addBtn setBackgroundColor:[UIColor colorWithRed:208/255.f green:71/255.f blue:45/255.f alpha:1]];
    [self.addBtn setCenter:CGPointMake(self.frame.size.width*0.9, self.frame.size.height*0.5)];
    //    self.textField.layer.borderWidth = 0.5f;
    [self.addBtn.titleLabel setFont:[UIFont systemFontOfSize:15.f]];
    self.addBtn.layer.cornerRadius = 2.f;
