...
typedef NS_ENUM(NSInteger, SIAlertViewButtonType) {
    ...
    SHAlertVIewButtonType ,    //三生专用类型button
    SHAlertVIewGrayButtonType,  //三生专用类型button
    SHAlertVIewPasswordType,    //三生专用类型button
    SHAlertVIewButtonTypeSinaWeiBo,    //三生专用类型button
    SHAlertVIewButtonTypeWeiXin,        //三生专用类型button
    SHAlertVIewButtonTypeTencentWeiBo,  //三生专用类型button
    SHAlertVIewButtonTypeWeiXinGroup,
    SHAlertVIewButtonTypeCancel
...
typedef NS_ENUM(NSInteger, SIAlertViewStyle) {
    SIAlertViewPasswordStyle = 0,
    SIAlertViewTowButtonStyle,
    SIAlertViewShareCenterStyle
};
...
@property (nonatomic) BOOL isTowButton;
@property (nonatomic) BOOL isPassword;
@property (nonatomic, assign) SIAlertViewStyle viewStyle;
