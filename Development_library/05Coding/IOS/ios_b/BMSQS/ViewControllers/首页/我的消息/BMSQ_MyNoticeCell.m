...
- (void)setCellUp
{
    ...
    UIView* line0 = [[UIView alloc]initWithFrame:CGRectMake(0, 79, APP_VIEW_WIDTH-10, 1)];
...
- (void)setCellValue:(NSDictionary*)dicData
{
    ...
    [iv_logo sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",APP_SERVERCE_IMG_URL,[dicData objectForKey:@"logoUrl"]]]];
