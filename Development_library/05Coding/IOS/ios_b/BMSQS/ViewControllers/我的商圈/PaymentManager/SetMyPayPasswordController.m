...
@interface SetMyPayPasswordController ()
...
@implementation SetMyPayPasswordController
...
-(void)n_set{
    ...
    self.userMobile = [userD objectForKey:@"mobileNbr"];
//    self.userMobile = @"18758216513";////test
...
-(void)clickGetButton{
    ...
    [params setObject:@"sspp" forKey:@"action"];
...
-(void)clickSubButton{
    ...
    NSString* vcode = [gloabFunction getSign:@"checkPayPwdMsgCode" strParams:self.userMobile];
    [params setObject:[gloabFunction getUserToken] forKey:@"tokenCode"];
    [params setObject:vcode forKey:@"vcode"];
    [params setObject:[gloabFunction getTimestamp] forKey:@"reqtime"];
    
    __weak typeof(self) weakSelf =  self;
    [self.jsonPrcClient invokeMethod:@"checkPayPwdMsgCode" withParameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
...
-(void)setPayPwd:(NSString *)pw{
    ...
    NSString* vcode = [gloabFunction getSign:@"setPayPwd" strParams:[gloabFunction getShopCode]];
    [params setObject:[gloabFunction getUserToken] forKey:@"tokenCode"];
    [params setObject:vcode forKey:@"vcode"];
    [params setObject:[gloabFunction getTimestamp] forKey:@"reqtime"];
