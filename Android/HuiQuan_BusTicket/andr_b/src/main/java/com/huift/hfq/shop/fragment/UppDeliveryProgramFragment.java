...
import com.huift.hfq.shop.adapter.DeliveryProgramsAdapter;
import com.huift.hfq.shop.model.EditShopDeliveryTask;
	...
	public void getListShopDelivery() {
		new ListShopDeliveryTask(getActivity(), new ListShopDeliveryTask.Callback() {
			...
			public void getResult(JSONArray result) {
				...
				mShopList = new Gson().fromJson(result.toString(), new TypeToken<List<Shop>>() {
				}.getType());
