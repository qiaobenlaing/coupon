...
import com.huift.hfq.shop.adapter.ProductPhotoAdapter;
import com.huift.hfq.shop.model.AddSubAlbumPhotoTask;
import com.huift.hfq.shop.model.DelSubAlbumPhotoTask;
import com.huift.hfq.shop.model.GetSubAlbumPhotoTask;
import com.huift.hfq.shop.model.UpdateSubAlbumTask;
...
public class ProductPhotoActivity extends Activity {
	...
	private void updateHead(Bitmap bitmap) {
		try {
			...
			String mPicPath = Tools.getFilePath(ProductPhotoActivity.this) + System.currentTimeMillis() + ".jpg";
