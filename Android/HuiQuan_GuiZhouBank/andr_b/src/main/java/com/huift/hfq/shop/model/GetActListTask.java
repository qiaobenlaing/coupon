...
public class GetActListTask extends SzAsyncTask<String, String, Integer> {
	...
	private final static String TAG = "GetActListTask";
	 ...
	 * @param acti
	 */
	public GetActListTask(Activity acti,Callback callback) {
		super(acti);
	...
	protected Integer doInBackground(String... params) {
		...
		try {
			...
			mResult = (JSONObject)API.reqShop("sGetActList", reqParams);
