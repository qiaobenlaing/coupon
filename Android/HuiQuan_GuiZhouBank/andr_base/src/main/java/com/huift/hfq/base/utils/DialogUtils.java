...
public class DialogUtils {
	 ...
	 *输入餐桌号
	 */
	public static void showInputDialog(Activity activity, String title, String msg, String btnok, String btncancel, final OnResListener onResListener){
		...
		TextView tvTitle = (TextView) view.findViewById(R.id.tv_dialgo_title);//标题
		tvTitle.setText(title);
		TextView tv_msg = (TextView) view.findViewById(R.id.tv_msg);//标题
		tv_msg.setText(msg);
		final EditText tv_input = (EditText) view.findViewById(R.id.et_dailog_table);//餐桌号
		...
		btnOk.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				String inputTable = tv_input.getText().toString();
