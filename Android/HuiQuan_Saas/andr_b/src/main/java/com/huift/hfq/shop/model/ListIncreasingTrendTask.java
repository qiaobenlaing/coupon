 ...
 *
 */
public class ListIncreasingTrendTask extends SzAsyncTask<String, Integer, Integer> {

	private final static String TAG = "ListIncreasingTrendTask";
	/** 定义一个正确的返回结果码 **/ 
	 ...
	 * @param acti 调用者的上下文
	 */
	public ListIncreasingTrendTask(Activity acti) {
		super(acti);
	}
	 ...
	 * @param callback 回调方法
	 */
	public ListIncreasingTrendTask(Activity acti, Callback callback) {
		super(acti);
		mCallback = callback;
	}
	...
	protected Integer doInBackground(String... params) {
		...
		try {
			//调用API
			mResult = (JSONArray) API.reqShop("listIncreasingTrend", reqparams);
