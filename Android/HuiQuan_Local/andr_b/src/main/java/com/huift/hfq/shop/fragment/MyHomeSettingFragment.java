...
public class MyHomeSettingFragment extends Fragment {
	...
	private void init(View v) {
		...
		//注册id
		mRegistrationId = DB.getStr(ShopConst.RegisterSave.JPUSH_REGID);
		//标题设置
	...
	OnClickListener exitListener = new OnClickListener() {
		...
		public void onClick(View v) {
			//友盟统计
			MobclickAgent.onEvent(getActivity(), "myhome_fragment_exit");
			...
			public void getResult(JSONObject object) {
				if (object == null) {
					...
					if (String.valueOf(ErrorCode.SUCC).equals(object.get("code").toString())) {
						SharedPreferences mSharedPreferences = getActivity().getSharedPreferences(ShopConst.LoginSave.LOGIN_KEEP, Context.MODE_PRIVATE);
